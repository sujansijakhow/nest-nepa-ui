...
export default function PricingSection() {
    // Google Workspace icons for header
    ...
    return (
        <section className="w-full bg-white py-16 md:py-24">
            <div className="mx-auto max-w-6xl px-4 md:px-10">
                ...
                {/* Main Heading */}
                <div className="text-center md:flex flex-col items-center mb-20">
                    <span className="text-3xl font-medium mb-2">
                        के <span className="text-[#4285F4] text-3xl md:text-4xl">Google Workspace</span> तपाईंको
                    </span>
                    <span className="ml-2 md:ml-0 text-4xl mb-6">
                        business growth <span className="text-[#4285F4] text-3xl">को लागि</span> best fit <span className="text-[#4285F4] text-3xl">हो?</span>
                    </span>
                ...
                <div className="grid md:grid-cols-3 gap-6 md:gap-8">
                    ...
                    <div className="flex flex-col items-center md:border-r border-gray-300">
                        ...
                        <div className="mb-6 flex flex-col gap-4">
                            ...
                            <div className="flex flex-col items-center">
                                <p className="text-sm text-gray-600 mt-2">per user / month,</p>
                                <p className="text-sm text-gray-600">1 year commitment <span className="text-blue-500">ⓘ</span> </p>
                            </div>
                        </div>

                        <Button variant="secondary" className="bg-pink-50 text-pink-600 border border-pink-200 flex gap-2 items-center rounded-xl">
                            <svg
                    ...
                    <div className="space-y-8 md:pr-8">
                                ...
                                {storageFeatures.map((feature, index) => (
                                    <div key={index} className="flex items-start gap-3 text-gray-700">
                                        <div className="w-5 h-5 relative flex-shrink-0 mt-1">
                                            <Image src={feature.icon} alt="icon" fill className="object-contain" />
                                        </div>
                                        <p>{feature.text}</p>
                                    </div>
                                ))}
                        ...
                        <div className="pl-6 md:pl-0">
                            ...
                            <div className="space-y-3">
                                {communicateFeatures.map((feature, index) => (
                                    <div key={index} className="flex items-start gap-3 text-gray-700">
                                        <div className="w-5 h-5 relative flex-shrink-0 mt-1">
                                            <Image src={feature.icon} alt="icon" fill className="object-contain" />
                                        </div>
                    ...
                    <div className="space-y-8 pl-6 md:pl-0">
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                {collaborateFeatures.map((feature, index) => (
                                    <div key={index} className="flex items-start gap-3 text-gray-700">
                                        <div className="w-5 h-5 relative flex-shrink-0 mt-1">
                                            <Image src={feature.icon} alt="icon" fill className="object-contain" />
                                        </div>
